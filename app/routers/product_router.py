...
@product_router.get("/by-name/{product_name}", response_model=ProductOut, status_code=status.HTTP_200_OK)
...
@product_router.get("/user/{user_id}", response_model=List[ProductOut], status_code=status.HTTP_200_OK)
