...
@user_router.get("/by-email/{email}", response_model=UserOut, status_code=status.HTTP_200_OK)
...
@user_router.post("/login", response_model=UserOut, status_code=status.HTTP_200_OK)
